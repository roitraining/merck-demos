...
![Search for Gemini Enterprise](images/search.png)
...
![Create the Gemini Enterprise Environment](images/create-environment.png)
...
![Open Gemini Enterprise in the browser](images/open-preview.png)
